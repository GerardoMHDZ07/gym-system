...
// TODO: reemplazar SELECT * por las columnas reales de "checkins" y agregar validación con zod
...
export async function getById(req: Request, res: Response) {
  const result = await pool.query("SELECT * FROM checkins WHERE id = $1", [req.params.id]);
