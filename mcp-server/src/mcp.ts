...
// Crea un McpServer con todos los tools registrados. Cada entry point (stdio,
// HTTP) usa su propia instancia: la sesión vive en el closure de la instancia,
// por lo que cada proceso tiene su propio estado de login.
